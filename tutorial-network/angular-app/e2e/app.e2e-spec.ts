...
describe('Starting tests for angular-app', function() {
  ...
  it('navbar-brand should be angular-app',() => {
    ...
    it('labRecord component should be loadable',() => {
      page.navigateTo('/labRecord');
      browser.findElement(by.id('assetName'))
      .then((assetName) => {
        return assetName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('labRecord');
      });
    });

    it('labRecord table should have 7 columns',() => {
      page.navigateTo('/labRecord');
    ...
    it('EHR table should have 11 columns',() => {
      page.navigateTo('/EHR');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Pharmacy table should have 4 columns',() => {
      page.navigateTo('/Pharmacy');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('InsuranceCompany table should have 3 columns',() => {
      page.navigateTo('/InsuranceCompany');
      element.all(by.css('.thead-cols th')).then(function(arr) {
    ...
    it('Lab table should have 3 columns',() => {
      page.navigateTo('/Lab');
      element.all(by.css('.thead-cols th')).then(function(arr) {
        expect(arr.length).toEqual(3); // Addition of 1 for 'Action' column
      });
    ...
    it('PlacePrescription component should be loadable',() => {
      page.navigateTo('/PlacePrescription');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('PlacePrescription');
      });
    });
  
    it('pickupConfirm component should be loadable',() => {
      page.navigateTo('/pickupConfirm');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('pickupConfirm');
      });
    });
  
    it('issueTest component should be loadable',() => {
      page.navigateTo('/issueTest');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('issueTest');
      });
    });
  
    it('createEHR component should be loadable',() => {
      page.navigateTo('/createEHR');
      browser.findElement(by.id('transactionName'))
      .then((transactionName) => {
        return transactionName.getText();
      })
      .then((txt) => {
        expect(txt).toBe('createEHR');
      });
    });
