...
describe('updateRecordComponent', () => {
  ...
  let mockupdateRecordService;
  let mockDataService

  beforeEach(async(() => {

    mockupdateRecordService = sinon.createStubInstance(updateRecordService);
    mockupdateRecordService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: updateRecordService, useValue: mockupdateRecordService },
