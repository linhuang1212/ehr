...
export class updateRecordComponent implements OnInit {
  ...
  labrecord = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.health.updateRecord',
      'labrecord': this.labrecord.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.labrecord) {
        formObject.labrecord = result.labrecord;
      } else {
        formObject.labrecord = null;
      }
